    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('colors.update', $info['id']) }}" method="POST" role="form">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="hexa_code" rows="3" placeholder="Enter ...">{{ $info['hexa_code'] }}</textarea>
                        </div>
                        <div class="form-group">
